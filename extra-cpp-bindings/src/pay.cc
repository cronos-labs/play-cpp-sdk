...
Str OptionalArguments::get_order_id() const { return order_id; }
Str OptionalArguments::get_return_url() const { return return_url; }
Str OptionalArguments::get_cancel_url() const { return cancel_url; }
Str OptionalArguments::get_sub_merchant_id() const { return sub_merchant_id; }
